...
class CalculadoraTest {
    ...
    void testEvaluarPostfixExpresionSimple() {
        ...
        int resultado = calculadora.operar(3,2,"+"); /*se guarda el resultado experimetal */
    ...
    void testDivisionEntreCero() { /*se crea un test para verificar que no se pueda dividir entre cero, el () -> hace referencia a "ejecutar " es una expresion lambda */
        ...
        assertThrows(ArithmeticException.class, () -> calculadora.operar(10,0,"/")); //se espera que se lance una excepcion de tipo ArithmeticException
    }
